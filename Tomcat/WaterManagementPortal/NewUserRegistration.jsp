	...
	font-size: 8pt
		...
		<body>
			...
			<form action="./newRegistrationAction.do" name="register"
				...
				<table border='0' align="center" width=70% bgcolor='Teal'>
								...
								<c:choose>
									<c:when test="${sessionScope.role eq 'admin'}">
										<option value="employee">
											<font size="3" face="Verdana">CityEmployee</font>
										</option>
									</c:when>
									<c:otherwise>
...
frmvalidator.addValidation("loginid", "req", "Please enter your LoginName");
frmvalidator.addValidation("loginid", "maxlen=20",
...
frmvalidator.addValidation("securityanswer", "req",
		"Please enter your Sesurity Question");
...
frmvalidator.addValidation("houseno", "req", "Please enter House Number");
frmvalidator.addValidation("houseno", "req", "Please enter House Number");
frmvalidator.addValidation("houseno", "req", "Please enter House Number");
frmvalidator.addValidation("houseno", "req", "Please enter House Number");
frmvalidator.addValidation("houseno", "req", "Please enter House Number");
